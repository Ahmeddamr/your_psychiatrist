...
import 'Cancel session.dart';

class CompletedCancellation extends StatelessWidget {
  const CompletedCancellation({super.key});
      ...
      body: Center(
        child: Column(
          children: [
            ...
            Text(' Please enter your email address to be notified '
                'when the cancellation and refund process is completed ',
